...
func (p TransportProtocol) Build() (string, error) {
	...
	case "xhttp", "splithttp":
		return "", errors.PrintRemovedFeatureError("XHTTP/splithttp transport", "tcp")
	case "kcp", "mkcp":
		return "", errors.PrintRemovedFeatureError("mKCP transport", "tcp")
	case "grpc":
		return "", errors.PrintRemovedFeatureError("gRPC transport", "tcp")
	case "ws", "websocket":
		return "", errors.PrintRemovedFeatureError("WebSocket transport", "tcp")
	case "httpupgrade":
		return "", errors.PrintRemovedFeatureError("HTTPUpgrade transport", "tcp")
	case "h2", "h3", "http":
		return "", errors.PrintRemovedFeatureError("HTTP transport (without header padding, etc.)", "tcp")
	case "quic":
		return "", errors.PrintRemovedFeatureError("QUIC transport (without web service, etc.)", "tcp")
	case "hysteria":
		return "", errors.PrintRemovedFeatureError("Hysteria transport", "tcp")
	default:
